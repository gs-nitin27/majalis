...
//echo "INSERT INTO `maj_create`(`name`, `phone_no`, `address1`, `address2`, `country`, `state`, `city`, `pincode`, `zakisname`, `date`, `time`, `type`) VALUES ('$item->name','$item->phone_no','$item->address1','$item->address2','$item->country','$item->state','$item->city','$item->pincode','$item->zakisname','$item->date','$item->time','$item->type' ) ON DUPLICATE KEY UPDATE `name` ='$item->name', `phone_no` = '$item->phone_no',`address1` = '$item->address1' ,`address2` = '$item->address2' ,`country` = '$item->country' ,`state` = '$item->state' , `city` = '$item->city' , `pincode` = '$item->pincode' , `zakisname` = '$item->zakisname' , `date` = '$item->date',`time` = '$item->time' ,`type` = '$item->type'";
